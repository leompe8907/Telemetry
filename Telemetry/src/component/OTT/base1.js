const OTT = () => {
  ...
  request.onupgradeneeded = (event) => {
    ...
    if (!db.objectStoreNames.contains('dataOTT')) {
      ...
      // Crea un índice por la propiedad 'dataName'
      dataOTTStore.createIndex('dateTimeIndex', 'dataTime');
      ...
      arrayAction8.forEach((obj8) => {
        ...
        if (matchingObj7) {
          ...
          const modifiedObj8 = {
            ...
            timestamp: new Date(obj8.timestamp).setHours(0, 0, 0, 0), // Solo milisegundos de mes/día/año
            dataTime: new Date(obj8.timestamp).toLocaleTimeString('en-US')
          };
